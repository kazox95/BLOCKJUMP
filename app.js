...
function starting_game() {
    ...
    function changeBiome2() {
        document.getElementById("main_img").src = "craftitium.netlify.app/Ressources/img_biome/biome2.png";
    };

    function changeBiome3() {
        document.getElementById("main_img").src = "craftitium.netlify.app/Ressources/img_biome/biome3.png";
    };

    function changeBiome4() {
        document.getElementById("main_img").src = "craftitium.netlify.app/Ressources/img_biome/biome4.png";
    };

    function changeBiome5() {
        document.getElementById("main_img").src = "craftitium.netlify.app/Ressources/img_biome/biome5.png";
    };

    function changeBiome6() {
        document.getElementById("main_img").src = "craftitium.netlify.app/Ressources/img_biome/biome6.png";
    };

    function changeBiome7() {
        document.getElementById("main_img").src = "craftitium.netlify.app/Ressources/img_biome/biome7.png";
    };


    // Mobs qui changent :
    function MobTransformSkeleton() {
        enemies.src = "craftitium.netlify.app/Ressources/skeleton.png";
    ...
    function MobTransformCreeper() {
        enemies.src = "craftitium.netlify.app/Ressources/creeper.png";
        enemies.style.width = "2.7rem";
    ...
    function MobTransformZDesert() {
        enemies.src = "craftitium.netlify.app/Ressources/zombie_desert.png";
        enemies.style.width = "2.7rem";
    }

    function MobTransformPigmen() {
        enemies.src = "craftitium.netlify.app/Ressources/pigmen.png";
        enemies.style.width = "2.7rem";
